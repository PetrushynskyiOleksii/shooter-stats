...
Revision ID: 94120aeea5af
Revises:
Create Date: 2018-09-02 14:31:23.592451
...
def upgrade():
    ...
    sa.Column('game_mod_id', sa.Integer(), nullable=False),
    sa.Column('server_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['game_mod_id'], ['game_mod.id'], ),
    sa.ForeignKeyConstraint(['server_id'], ['server.id'], ),
    sa.PrimaryKeyConstraint('game_mod_id', 'server_id')
    )
